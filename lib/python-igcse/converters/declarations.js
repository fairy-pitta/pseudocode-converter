...
const convertFunctionDef = (line, indentation, state) => {
    console.log(`[convertFunctionDef] Processing line: "${line.trim()}", pattern test: ${patterns_1.PATTERNS.FUNCTION_DEF.test(line)}`);
    console.log(`[convertFunctionDef] PATTERNS.FUNCTION_DEF: ${patterns_1.PATTERNS.FUNCTION_DEF}`);
